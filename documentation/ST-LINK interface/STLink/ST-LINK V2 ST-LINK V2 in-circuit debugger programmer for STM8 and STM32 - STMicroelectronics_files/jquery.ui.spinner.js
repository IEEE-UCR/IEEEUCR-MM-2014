...
$.widget('ui.spinner', {
	...
	_createButtons: function(input) {
		...
		var localtop = "";
		if($.browser.mozilla == true) { localtop = '-16px'};
		if($.browser.chrome == true) { localtop = '-4px'};
		if($.browser.msie == true) { localtop = '1px'};
		...
		/*buttons.css({ width: buttonWidth - (box ? buttons.outerWidth() - buttons.width() : 0), height: '9px' });*/
		upButton = buttons[0];
